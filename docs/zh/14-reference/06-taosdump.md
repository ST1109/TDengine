...
4.  备份系统库：TDengine 3.0 包含两个系统数据库 information_schema 和 performance_schema。这两个系统数据库和运行 TDengine 的实例相关，无需也不应备份或恢复到其他实例。taosdump 不支持备份 TDengine 3.0 的这两个系统数据库。
