 ...
 * Signature: (Lcom/taosdata/jdbc/tmq/JNIConsumer;)J
 */
JNIEXPORT jlong JNICALL Java_com_taosdata_jdbc_tmq_TMQConnector_tmqConfNewImp(JNIEnv *, jobject, jobject);
 ...
 * Signature: (JJLcom/taosdata/jdbc/tmq/JNIConsumer;)V
 */
